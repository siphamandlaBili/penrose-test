...
export default function OTPNotification({ isOpen, onClose, otp }) {
  return (
                ...
                <div>
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      ...
                      <p className="mt-2 text-2xl font-bold tracking-wider text-indigo-600 font-mono">
                        {otp}
                      </p>
                      <p className="mt-2 text-xs text-gray-400">
                        (This simulates an SMS message in development)
                      </p>
                    </div>
                  </div>
                </div>
